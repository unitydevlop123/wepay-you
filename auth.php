...
// Simple Authentication system - Configure session before starting
if (session_status() === PHP_SESSION_NONE) {
    ini_set('session.cookie_lifetime', 86400); // 24 hours
    ini_set('session.gc_maxlifetime', 86400);
    ini_set('session.cookie_path', '/');
    ini_set('session.cookie_secure', false); // Allow HTTP for development
    ini_set('session.cookie_httponly', true);
    session_start();
}
date_default_timezone_set('Africa/Lagos');

// Firebase automatically handles data storage - no paths needed
...
// addUserTransaction() function is now provided by firebase_setup.php
...
// addUserNotification() function is now provided by firebase_setup.php
